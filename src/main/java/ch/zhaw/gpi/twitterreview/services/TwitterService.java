 ...
 * @author Melek
 */
@Service // sagen dass es ein service component ist
public class TwitterService {
    ...
    // Inhalt in Klammer aus other Sources/twitter.properties
    ...
    @PostConstruct
    private void init() {
        // Versuchen, die Verbindung mit Twitter aufzubauen . Wenn's lauft ist es i.O ansonsten wird ein Fehler geworfen
        try {
            // Wenns Funktioniert:
            // twitter: Variable aus zeile 24. Variablen aus Zeilen 31 - 38
            // Anmelden bei Twitter API über die Zugangsdaten (Instanzierung)
            twitter = new TwitterTemplate(consumerKey, consumerSecret, accessToken, accessTokenSecret);

            // TimelineOperations-Objekt der entsprechenden Variable zuweisen. (Instanzierung)
