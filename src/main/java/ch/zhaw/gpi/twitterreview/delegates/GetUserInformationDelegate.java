 ...
 * @author Melek
 */
// Neue JavaDelegate-Klasse GetUserInformationDelegate mit @Named und execute wie üblich
...
public class GetUserInformationDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        // Vorname und EMail als prozessvariable übergeben
